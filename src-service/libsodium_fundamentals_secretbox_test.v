import libsodium as cmn
import libsodium.secretbox as sb

fn test_crypto_pwhash_is_not_an_empty_operation() {
	assert cmn.sodium_init() >= 0
...
fn test_crypto_pwhash_verify() {
	...
	salt := cmn.SaltForArgon2id13{[u8(110), 131, 121, 20, 151, 201, 189, 39, 109, 5, 8, 245, 109,
		92, 50, 100]}
